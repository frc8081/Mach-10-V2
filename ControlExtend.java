...
public class ControlExtend extends CommandBase {
  ...
  public void execute() {
    ...
    if(RobotContainer.extend.get_extend_encoder() <= -40.0 && speed<0.0){
      speed = 0.0;
    }else if(RobotContainer.extend.get_extend_encoder() >= -3.0 && speed>0.0){
      speed = 0.0;
    }
    RobotContainer.extend.extend(speed*0.5);
